...
class Test_pubchemQuery:
    ...
    def test_parse_pubchem_header(self):
        ...
        response.headers = {
            ...
            'Request Count status: Green (0%), Request Time status: Green (0%), Service status: Green (10%)'
        }
    ...
    def test__check_rate_status(mock_sleep):
        ...
        with patch('designspacediscovery.querypubchem.time.sleep',
                   return_value=None) as mock_time:
